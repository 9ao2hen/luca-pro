...
import cn.mervyn.luca.framework.tracer.core.aop.BizTraceAspect;
import cn.mervyn.luca.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "luca.tracer", value = "enable", matchIfMissing = true)
public class LucaTracerAutoConfiguration {
