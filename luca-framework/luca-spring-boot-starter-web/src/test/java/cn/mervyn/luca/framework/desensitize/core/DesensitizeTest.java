package cn.mervyn.luca.framework.desensitize.core;

import cn.mervyn.luca.framework.common.util.json.JsonUtils;
import cn.mervyn.luca.framework.desensitize.core.annotation.Address;
import cn.mervyn.luca.framework.desensitize.core.regex.annotation.EmailDesensitize;
import cn.mervyn.luca.framework.desensitize.core.regex.annotation.RegexDesensitize;
import cn.mervyn.luca.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("墨文源码");
        ...
        desensitizeDemo.setRegex("你好，我是墨文源码");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("墨文源码");
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "墨文源码", replacer = "*")
