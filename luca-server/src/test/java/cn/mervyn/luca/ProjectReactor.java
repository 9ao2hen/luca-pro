...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.mervyn.boot";
    private static final String ARTIFACT_ID = "luca";
    private static final String PACKAGE_NAME = "cn.mervyn.luca";
    private static final String TITLE = "墨文管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.mervyn.boot";
        String artifactIdNew = "luca";
        String packageNameNew = "cn.mervyn.luca";
        String titleNew = "墨文管理系统";
