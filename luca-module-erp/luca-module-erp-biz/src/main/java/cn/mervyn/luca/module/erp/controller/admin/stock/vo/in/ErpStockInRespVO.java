package cn.mervyn.luca.module.erp.controller.admin.stock.vo.in;
...
import static cn.mervyn.luca.module.erp.enums.DictTypeConstants.AUDIT_STATUS;
...
public class ErpStockInRespVO {
    ...
    @Schema(description = "供应商名称", example = "墨文")
    @ExcelProperty("供应商名称")
    ...
    @Schema(description = "创建人", example = "墨文")
    private String creator;
    @Schema(description = "创建人名称", example = "墨文")
