package cn.mervyn.luca.framework.ai.core.factory;
...
import cn.mervyn.luca.framework.ai.config.LucaAiAutoConfiguration;
import cn.mervyn.luca.framework.ai.config.LucaAiProperties;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            LucaAiProperties.MidjourneyProperties properties = SpringUtil.getBean(LucaAiProperties.class).getMidjourney();
    ...
    /**
     * 可参考 {@link LucaAiAutoConfiguration#deepSeekChatModel(LucaAiProperties)}
     */
    ...
    /**
     * 可参考 {@link LucaAiAutoConfiguration#xingHuoChatClient(LucaAiProperties)}
     */
