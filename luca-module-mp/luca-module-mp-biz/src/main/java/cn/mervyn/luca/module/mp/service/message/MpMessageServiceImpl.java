package cn.mervyn.luca.module.mp.service.message;
...
import cn.mervyn.luca.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import cn.mervyn.luca.module.mp.convert.message.MpMessageConvert;
...
import cn.mervyn.luca.module.mp.dal.dataobject.user.MpUserDO;
import cn.mervyn.luca.module.mp.dal.mysql.message.MpMessageMapper;
import cn.mervyn.luca.module.mp.enums.message.MpMessageSendFromEnum;
import cn.mervyn.luca.module.mp.framework.mp.core.MpServiceFactory;
import cn.mervyn.luca.module.mp.framework.mp.core.util.MpUtils;
import cn.mervyn.luca.module.mp.service.account.MpAccountService;
import cn.mervyn.luca.module.mp.service.material.MpMaterialService;
import cn.mervyn.luca.module.mp.service.message.bo.MpMessageSendOutReqBO;
import cn.mervyn.luca.module.mp.service.user.MpUserService;
...
import static cn.mervyn.luca.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
