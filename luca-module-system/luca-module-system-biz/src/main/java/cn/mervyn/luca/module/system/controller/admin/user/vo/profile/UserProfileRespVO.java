package cn.mervyn.luca.module.system.controller.admin.user.vo.profile;
...
public class UserProfileRespVO {
    ...
    @Schema(description = "用户账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "luca")
    private String username;

    @Schema(description = "用户昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "芋艿")
    private String nickname;

    @Schema(description = "用户邮箱", example = "luca@iocoder.cn")
