package cn.mervyn.luca.module.system.service.tenant;

import cn.mervyn.luca.framework.common.enums.CommonStatusEnum;
import cn.mervyn.luca.framework.common.pojo.PageResult;
import cn.mervyn.luca.framework.tenant.config.TenantProperties;
...
import cn.mervyn.luca.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import cn.mervyn.luca.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import cn.mervyn.luca.module.system.dal.dataobject.permission.MenuDO;
import cn.mervyn.luca.module.system.dal.dataobject.permission.RoleDO;
import cn.mervyn.luca.module.system.dal.dataobject.tenant.TenantDO;
import cn.mervyn.luca.module.system.dal.dataobject.tenant.TenantPackageDO;
import cn.mervyn.luca.module.system.dal.mysql.tenant.TenantMapper;
import cn.mervyn.luca.module.system.enums.permission.RoleCodeEnum;
import cn.mervyn.luca.module.system.enums.permission.RoleTypeEnum;
import cn.mervyn.luca.module.system.service.permission.MenuService;
...
import cn.mervyn.luca.module.system.service.tenant.handler.TenantInfoHandler;
import cn.mervyn.luca.module.system.service.tenant.handler.TenantMenuHandler;
...
import static cn.mervyn.luca.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
import static cn.mervyn.luca.module.system.enums.ErrorCodeConstants.*;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("墨文", user.getNickname());
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("墨文"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("墨文");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
