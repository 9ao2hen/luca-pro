package cn.mervyn.luca.module.system.service.mail;
...
import cn.mervyn.luca.module.system.controller.admin.mail.vo.template.MailTemplateSaveReqVO;
import cn.mervyn.luca.module.system.controller.admin.mail.vo.template.MailTemplatePageReqVO;
import cn.mervyn.luca.module.system.dal.dataobject.mail.MailTemplateDO;
import cn.mervyn.luca.module.system.dal.mysql.mail.MailTemplateMapper;
...
import static cn.mervyn.luca.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
        ...
        // 测试 name 不匹配
        mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("墨文")));
        // 测试 code 不匹配
