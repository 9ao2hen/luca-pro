package cn.mervyn.luca.module.system.service.user;
...
import cn.mervyn.luca.framework.common.util.collection.ArrayUtils;
...
import cn.mervyn.luca.module.infra.api.config.ConfigApi;
import cn.mervyn.luca.module.infra.api.file.FileApi;
...
import cn.mervyn.luca.module.system.controller.admin.user.vo.user.*;
...
import cn.mervyn.luca.module.system.dal.dataobject.dept.UserPostDO;
...
import cn.mervyn.luca.module.system.dal.mysql.dept.UserPostMapper;
import cn.mervyn.luca.module.system.dal.mysql.user.AdminUserMapper;
import cn.mervyn.luca.module.system.enums.common.SexEnum;
...
import cn.mervyn.luca.module.system.service.tenant.TenantService;
...
import static cn.mervyn.luca.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("lucayuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("lucayuanma");
        ...
        assertEquals("lucayuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("lucayuanma"))).thenReturn("java");
