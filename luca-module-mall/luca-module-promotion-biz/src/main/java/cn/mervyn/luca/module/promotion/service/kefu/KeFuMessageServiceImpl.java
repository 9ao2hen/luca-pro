package cn.mervyn.luca.module.promotion.service.kefu;
...
import cn.mervyn.luca.module.infra.api.websocket.WebSocketSenderApi;
import cn.mervyn.luca.module.member.api.user.MemberUserApi;
import cn.mervyn.luca.module.promotion.controller.admin.kefu.vo.message.KeFuMessagePageReqVO;
import cn.mervyn.luca.module.promotion.controller.admin.kefu.vo.message.KeFuMessageSendReqVO;
...
import cn.mervyn.luca.module.promotion.dal.dataobject.kefu.KeFuConversationDO;
import cn.mervyn.luca.module.promotion.dal.dataobject.kefu.KeFuMessageDO;
import cn.mervyn.luca.module.promotion.dal.mysql.kefu.KeFuMessageMapper;
...
import static cn.mervyn.luca.module.promotion.enums.ErrorCodeConstants.KEFU_CONVERSATION_NOT_EXISTS;
import static cn.mervyn.luca.module.promotion.enums.WebSocketMessageTypeConstants.KEFU_MESSAGE_ADMIN_READ;
import static cn.mervyn.luca.module.promotion.enums.WebSocketMessageTypeConstants.KEFU_MESSAGE_TYPE;
