...
import cn.mervyn.luca.module.promotion.api.combination.dto.CombinationValidateJoinRespDTO;
import cn.mervyn.luca.module.promotion.controller.admin.combination.vo.recrod.CombinationRecordReqPageVO;
import cn.mervyn.luca.module.promotion.controller.app.combination.vo.record.AppCombinationRecordPageReqVO;
...
import cn.mervyn.luca.module.promotion.dal.mysql.combination.CombinationRecordMapper;
import cn.mervyn.luca.module.promotion.enums.combination.CombinationRecordStatusEnum;
import cn.mervyn.luca.module.trade.api.order.TradeOrderApi;
...
import static cn.mervyn.luca.framework.common.util.date.LocalDateTimeUtils.afterNow;
import static cn.mervyn.luca.framework.common.util.date.LocalDateTimeUtils.beforeNow;
