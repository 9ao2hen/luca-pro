package cn.mervyn.luca.module.product.controller.app.spu.vo;

import cn.mervyn.luca.module.product.controller.app.property.vo.value.AppProductPropertyValueDetailRespVO;
...
public class AppProductSpuDetailRespVO {
    ...
    @Schema(description = "商品名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "墨文")
    private String name;
