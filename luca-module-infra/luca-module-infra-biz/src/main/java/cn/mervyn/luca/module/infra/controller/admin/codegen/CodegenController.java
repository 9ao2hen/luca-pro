package cn.mervyn.luca.module.infra.controller.admin.codegen;
...
import cn.mervyn.luca.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import cn.mervyn.luca.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import cn.mervyn.luca.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import cn.mervyn.luca.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import cn.mervyn.luca.module.infra.convert.codegen.CodegenConvert;
...
import cn.mervyn.luca.module.infra.service.codegen.CodegenService;
...
import static cn.mervyn.luca.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "luca"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "墨文")
    })
