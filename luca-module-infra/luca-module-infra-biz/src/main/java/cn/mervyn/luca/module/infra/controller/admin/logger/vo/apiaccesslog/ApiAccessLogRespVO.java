package cn.mervyn.luca.module.infra.controller.admin.logger.vo.apiaccesslog;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(cn.mervyn.luca.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
    ...
    @Schema(description = "结果提示", example = "墨文源码，牛逼！")
    @ExcelProperty("结果提示")
