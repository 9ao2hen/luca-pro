package cn.mervyn.luca.module.infra.service.codegen.inner;
...
import cn.mervyn.luca.framework.apilog.core.enums.OperateTypeEnum;
...
import cn.mervyn.luca.framework.excel.core.annotations.DictFormat;
import cn.mervyn.luca.framework.excel.core.convert.DictConvert;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "luca-module-${table.moduleName}/" + // 顶级模块
                "luca-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "luca-module-${table.moduleName}/" + // 顶级模块
                "luca-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "luca-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "luca-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
