package cn.mervyn.luca.module.infra.service.logger;
...
import cn.mervyn.luca.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.mervyn.luca.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.mervyn.luca.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.mervyn.luca.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.mervyn.luca.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.mervyn.luca.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("luca-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("luca-test");
