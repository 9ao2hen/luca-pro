...
import cn.mervyn.luca.module.bpm.controller.admin.definition.vo.group.BpmUserGroupSaveReqVO;
...
import cn.mervyn.luca.module.bpm.dal.mysql.definition.BpmUserGroupMapper;
...
import static cn.mervyn.luca.module.bpm.enums.ErrorCodeConstants.USER_GROUP_NOT_EXISTS;
...
public class BpmUserGroupServiceTest extends BaseDbUnitTest {
    ...
    public void testGetUserGroupPage() {
       ...
       // 测试 name 不匹配
       userGroupMapper.insert(cloneIgnoreId(dbUserGroup, o -> o.setName("墨文")));
       // 测试 status 不匹配
