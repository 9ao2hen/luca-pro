package cn.mervyn.luca.module.bpm.controller.admin.definition.vo.process;
...
public class BpmProcessDefinitionRespVO {
    ...
    @Schema(description = "流程名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "墨文")
    private String name;

    @Schema(description = "流程标识", requiredMode = Schema.RequiredMode.REQUIRED, example = "luca")
    private String key;

    @Schema(description = "流程图标", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.iocoder.cn/luca.jpg")
    private String icon;
